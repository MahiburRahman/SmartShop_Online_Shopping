...
?>
	 ...
	 <!--input type="submit" name="login" id="login" value="Logout" />
        ...
        <form name="myForm" action="lenovo_insert.php" onsubmit ="return validateForm()" method="post">
      <table>
		  ...
		  <td><br><br><br><b>We accept payment via <em>"bKash"</em>.Please fill required sectors below to confirm your order :-</b><br><br>
                  ...
                  bKash Transaction ID (TrxID):<br>
					...
					<!-- Paid Amount(BDT):<br>
						...
						<input type="hidden" name="lpt" id="nop" style="width:300px;" value="lenovo" />
...
else
{
   ...
   <p>Please either login below, or <a href="register.php">click here to register</a>.</p>
	...
	<form method="post" action="lenovo_form.php" name="loginform" id="loginform">
	<fieldset>
		...
		<input type="submit" name="login" id="login" value="Login"  class="button" onclick="parent.location='lenovo_form.php'"/>
	</fieldset>
	</form>
	</div>
